...
[![Last Rhiza Sync](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/tschm/jquantstats/copilot/add-latest-sync-date-display/.github/badges/rhiza-sync.json)](https://github.com/tschm/jquantstats/actions/workflows/rhiza_sync.yml)
